...
?>
  ...
  <div class="panel-body">
     ...
     <p><a href="<?=base_url('member/berita')?>"><button class="btn btn-sm btn-info"><i class="glyphicon glyphicon-repeat"></i> Kembali</button></a> <a href="<?=base_url('blog/'.$slug)?>"><button class="btn btn-sm btn-info"><i class="glyphicon glyphicon-repeat"></i> View Article</button></a>
     </p>
