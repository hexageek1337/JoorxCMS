...
<div class="image-count center">
	<img class="img-responsive img-rounded" src="<?php echo base_url().'assets/images/dracos.jpg'; ?>" alt="<?php echo $this->config->item('joorxcms_title'); ?>" title="<?php echo $this->config->item('joorxcms_title'); ?>">
</div>
  <br />
