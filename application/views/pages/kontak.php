...
<div class="image-count center">
	<img class="img-responsive img-rounded" src="<?php echo base_url().'assets/images/woman-sunglasses.jpg'; ?>" alt="Contact - <?php echo $this->config->item('joorxcms_title'); ?>" title="Contact - <?php echo $this->config->item('joorxcms_title'); ?>">
</div>
  <br />
...
Fusce sit amet ornare enim. Donec bibendum luctus nisl ut euismod. Ut aliquet semper mi, et luctus leo euismod ut. Ut lacinia vestibulum tortor. Suspendisse et maximus ex. Morbi cursus est vitae sagittis commodo. Quisque congue, nunc vel malesuada molestie, dui felis luctus ligula, nec pellentesque purus ipsum quis eros. Nulla laoreet magna id velit mattis, sed condimentum sapien mattis. Etiam eu mauris tempor, tincidunt enim non, lacinia nulla.</p>
</div>
<!-- Content JoorxCMS -->