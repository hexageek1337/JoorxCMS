...
<div class="image-count center">
	<img class="img-responsive img-rounded" src="<?php echo base_url().'assets/images/fuelphp.jpg'; ?>" alt="About - <?php echo $this->config->item('joorxcms_title'); ?>" title="About - <?php echo $this->config->item('joorxcms_title'); ?>">
</div>
  <br />
